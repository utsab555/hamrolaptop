...
<div class="contact-section">
  <div class="contact-item">
    <i class="fa-solid fa-phone"></i>
     <button class="shopbtn"><a href="#">01-5353308, 01-5348500</a></button> 
  </div>
  <div class="contact-item">
    <i class="fa-solid fa-envelope"></i>
      <button class="shopbtn"><a href="#">hamro_laptop@gmail.com</a></button> 
    </div>
  <div class="contact-item">
    <i class="fa-sharp fa-solid fa-location-dot"></i>
      <button class="shopbtn"><a href="#">Newroad, Kathmandu</a></button> 
    </div>
...
<div class="contact-section">
  <div class="contact-item">
     ...
     <button class="shopbtn"><a href="#">Facebook</a></button> 
  </div>
  <div class="contact-item">
      <i class="fab fa-twitter"></i>
      <button class="shopbtn"><a href="#">X</a></button> 
    </div>
  <div class="contact-item">
      <i class="fab fa-instagram"></i>
      <button class="shopbtn"><a href="#">Instagram</a></button> 
    </div>
  <div class="contact-item">
      <i class="fab fa-linkedin"></i>
      <button class="shopbtn"><a href="#">Linkedin</a></button> 
    </div>
  <div class="contact-item">
      <i class="fab fa-youtube"></i>
      <button class="shopbtn"><a href="#">Youtube</a></button> 
    </div>
</div>
<br>
<br>
