...
$laptop_id = isset($_GET['laptop_id']) ? $_GET['laptop_id'] : null;
...
<div class="indexcontainer" style="height: 100%;">
  <div class="card">
    <div class="profile-header">
      ...
      <h1 style="font-size: 40px;">Seller's Profile <button> <a href="buy.php" style="font-size:30px; color:darkgreen;">X</a></button> </h1>
        <?php
...
<main>
  <div>
  <h1 style=" font-size: 20px; text-align:center;">OtherLaptops By this user</h1>
      
          <!-- Cards Section -->
          <div id="cardcontainer">
            <?php
               $sql = "SELECT s.l_id,s.l_name,u.fullname as username,u.id ,s.l_model,s.l_processor,s.l_ram,s.l_storage,s.l_display,s.l_amount,s.l_addinfo,s.l_image,s.l_uploaddate,s.approval_status from second_hand_laptops s join users u on s.l_userid = u.id where s.approval_status='approved' and u.id=$user_id and s.l_id != $laptop_id";
